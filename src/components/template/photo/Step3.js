				...
				<div className="container">
					...
					<div className="search_result_wrap">
						<div className="search_result_item">
							...
							<img src={process.env.PUBLIC_URL + '/static/images/result_01.jpg'} alt="검색결과"/>
						</div>
						<div className="search_result_item">
							<div className="search_result_txt">
								<h4>마이폴캡슐</h4>
							...
							<img src={process.env.PUBLIC_URL + '/static/images/result_02.jpg'} alt="검색결과"/>
						</div>
						<div className="search_result_item">
							<div className="search_result_txt">
								<h4>부스코판당의정</h4>
							...
							<img src={process.env.PUBLIC_URL + '/static/images/result_03.jpg'} alt="검색결과"/>
						</div>
					</div>
					<p>일치하는 약을 찾지 못하셨나요?</p>
					<Link to="" className="direct_search_btn">직접 검색해보기</Link>
				</div>
