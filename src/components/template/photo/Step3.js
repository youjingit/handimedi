...
function PhotoStep3() {
	return (
		<div>
			...
			<main>
				<div className="photo_complete_wrap">
					<h2>사진 검색 결과</h2>
					<div className="search_result_wrap">
						<div className="search_result_item">
							...
							<img src="/static/images/result_01.jpg" alt="검색결과"/>
						</div>
						<div className="search_result_item">
							<div className="search_result_txt">
								<h4>마이폴캡슐</h4>
							...
							<img src="/static/images/result_02.jpg" alt="검색결과"/>
						</div>
						<div className="search_result_item">
							<div className="search_result_txt">
								<h4>부스코판당의정</h4>
							...
							<img src="/static/images/result_03.jpg" alt="검색결과"/>
						</div>
					</div>
